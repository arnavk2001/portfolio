...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg bg-ocean-light/10 dark:bg-ocean-light/5 hover:bg-ocean-light/20 dark:hover:bg-ocean-light/10 transition-colors border border-ocean-light/20"
