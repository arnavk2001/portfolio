          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              ...
              >
                ...
                <Text variant="secondary" size="sm" className="mb-2">Connect professionally</Text>
                <Text variant="muted" size="sm">@a3kulkarni</Text>
              </a>
              ...
              >
                ...
                <Text variant="secondary" size="sm" className="mb-2">Check out my code</Text>
                <Text variant="muted" size="sm">@arnavk2001</Text>
              </a>
            </div>
