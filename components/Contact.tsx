  ...
  return (
    <section id="contact" className="py-32 px-6 relative">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-strong rounded-3xl p-12 shadow-2xl border border-border-default relative overflow-hidden">
          {/* Gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-ocean-light/5 to-ocean-blue/5"></div>
          
          <div className="relative z-10">
            <Text size="xl" variant="secondary" className="text-center mb-12 leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <a 
                ...
                className="glass rounded-2xl p-6 hover:bg-ocean-light/10 transition-all group text-center"
              >
                <div className="inline-flex p-4 rounded-xl bg-ocean-blue/20 mb-4">
                  <svg className="w-6 h-6 text-ocean-blue" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                className="glass rounded-2xl p-6 hover:bg-ocean-light/10 transition-all group text-center"
              >
                <div className="inline-flex p-4 rounded-xl bg-ocean-dark/20 mb-4">
                  <svg className="w-6 h-6 text-ocean-dark" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <Button 
                ...
                size="lg"
                className="shadow-2xl shadow-ocean-light/25"
              >
        ...
        <footer className="mt-16 text-center">
          <div className="flex justify-center gap-8 mb-6">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-secondary hover:text-text-primary transition-all transform hover:scale-110"
              aria-label="LinkedIn"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
          ...
          <Text variant="secondary">
            Designed & Built by <Text as="span" className="gradient-text font-semibold">Arnav Kulkarni</Text>
          </Text>
