      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="glass-strong rounded-3xl p-8 shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 group hover:-translate-y-2 border border-slate-700/50 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-3">
                    <a 
                      href={project.github}
                      className="p-2 glass rounded-lg hover:bg-slate-700/50 transition-all group/icon"
                      aria-label="GitHub"
                    >
                      <svg className="w-5 h-5 text-slate-400 group-hover/icon:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-5 h-5 text-slate-400 group-hover/icon:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-slate-300 mb-6 leading-relaxed min-h-[4.5rem]">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, idx) => (
                    <span 
                      key={idx}
                      className="px-3 py-1.5 bg-slate-800/80 text-slate-300 rounded-lg text-sm border border-slate-700 hover:border-blue-500/50 transition-colors font-medium"
                    >
                      {tech}
                    </span>
                  ))}
